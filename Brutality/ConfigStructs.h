...
struct HealthBar : ColorToggle {
    ...
    Color4 TopGradient{ 0.2f,1.f,0.2f,1.f };
    Color4 BottomGradient{ 1.f,0.2f,0.2f,1.f };
...
struct Player : Shared {
    ...
    ColorToggle dormant{ 0.5f, 0.5f, 0.5f, 1.f };
    int hpside{ 0 };
    ColorToggle weapon;
...
struct OffscreenEnemies : ColorToggle {
    OffscreenEnemies() : ColorToggle{ { 1.0f, 1.0f, 1.0f, 1.0f } } {}
    int offset = 260;
    int size = 30;
};
