...
{
    void colorPicker(const char* name, float color[3], float* alpha = nullptr, bool* enable = nullptr, float* thickness = nullptr, float* rounding = nullptr, bool* outline = nullptr) noexcept;
